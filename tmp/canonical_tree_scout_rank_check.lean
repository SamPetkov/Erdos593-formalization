...
namespace Erdos593.TripleSystem.TriangleHost.ErdosRado.TmpRankCheck
...
theorem treeRank_eq_height (α : TraceCarrier) :
  ...
  induction α using WellFounded.induction wellFounded_lt with
  | h α ih =>
      apply le_antisymm
...
end Erdos593.TripleSystem.TriangleHost.ErdosRado.TmpRankCheck
